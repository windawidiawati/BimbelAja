  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      ...
      <ul class="navbar-nav me-auto d-lg-none">
        <li class="nav-item">
          <a class="nav-link" href="../tutor/buku_panduan/Manual_Book_Tutor_Bimbelaja.pdf" target="_blank">
      ...
      <ul class="navbar-nav ms-auto d-none d-lg-flex">
        <li class="nav-item">
          <a class="nav-link text-white" href="../tutor/buku_panduan/Manual_Book_Tutor_Bimbelaja.pdf" target="_blank">
            <i class="bi bi-book me-1"></i> Buku Panduan
          </a>
        </li>
        <li class="nav-item">
