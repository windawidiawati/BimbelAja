  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      ...
      <ul class="navbar-nav me-auto d-lg-none">
        <li class="nav-item">
          <a class="nav-link" href="../tutor/buku_panduan/Buku_Panduan_Tutor_BimbelAja.pdf" target="_blank">
        ...
        <li class="nav-item"><a class="nav-link <?= ($current_page === 'absensi_offline.php') ? 'active' : '' ?>" href="../tutor/absensi_offline.php"><i class="bi bi-list-check me-1"></i> Absensi</a></li>
      ...
      <!-- Menu profil & logout + buku panduan desktop -->
      <ul class="navbar-nav ms-auto d-none d-lg-flex">
        <li class="nav-item">
          <a class="nav-link text-white" href="../tutor/buku_panduan/Buku_Panduan_Tutor_BimbelAja.pdf" target="_blank">
            <i class="bi bi-book me-1"></i> Buku Panduan
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= ($current_page === 'profil.php') ? 'active' : '' ?>" href="../tutor/profil.php">
...
<div class="sidebar d-none d-lg-block">
  ...
  <a class="<?= ($current_page === 'absensi_tutor.php') ? 'active' : '' ?>" href="../tutor/absensi_tutor.php"><i class="bi bi-check-circle me-2"></i> Absensi Tutor</a>
</div>
